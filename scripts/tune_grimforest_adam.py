...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--debug-dir", default="data/output/debug/grim_forest_standalone")
    parser.add_argument("--template-dir", default="data/assets/images/grimforest_test")
    parser.add_argument(
        "--report-path",
        default="data/output/debug/grim_forest_standalone/grimforest_adam_threshold_report.json",
    )
    parser.add_argument(
        "--benchmark",
        action="store_true",
