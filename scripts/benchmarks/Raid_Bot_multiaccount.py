...
# `python scripts/benchmarks/Raid_Bot_multiaccount.py`
...
if TYPE_CHECKING:
    from raid_bot.mainframe import RSL_Bot_Mainframe
...
def _run_account_once(
    ...
    try:
        from scripts.benchmarks import multi_account_startup as startup
        from raid_bot.mainframe import RSL_Bot_Mainframe
