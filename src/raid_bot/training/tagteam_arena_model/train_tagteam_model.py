...
from raid_bot.training.tagteam_arena_model.utils.data_loading import (
    load_prepared_arrays,
    normalize_powers,
    print_npz_inspection,
    save_json,
)
from raid_bot.training.tagteam_arena_model.utils.metrics import binary_metrics
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", default="data/models/tagteam_arena_model/outputs")
...
def main() -> int:
    ...
    try:
        ...
        from raid_bot.training.tagteam_arena_model.models.tagteam_model import TagTeamArenaModel as TagTeamArenaModel_module
        from raid_bot.training.tagteam_arena_model.utils.data_loading import TagTeamArenaDataset as TagTeamArenaDataset_module
